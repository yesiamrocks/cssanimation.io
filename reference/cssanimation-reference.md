...
- `ca__fx-breezeLift`
- `ca__fx-buzz`
- `ca__fx-ca__mask-insetSwipeIn`
- `ca__fx-ca__mask-linesSlideIn`
- `ca__fx-ca__mask-rainRevealIn`
- `ca__fx-clipAnimate`
...
- `ca__fx-mask-angleSweepRightIn`
- `ca__fx-mask-checkerboardIn`
- `ca__fx-mask-diamondIn`
- `ca__fx-mask-explosionRevealIn`
- `ca__fx-mask-horizontalBarsIn`
- `ca__fx-mask-irisOpenIn`
- `ca__fx-mask-reflectiveWipeIn`
- `ca__fx-mask-shutterLinesIn`
- `ca__fx-mask-stairStepIn`
- `ca__fx-mask-stripesDiagonalLeftIn`
- `ca__fx-mask-stripesDiagonalLeftOut`
- `ca__fx-mask-stripesDiagonalUpIn`
- `ca__fx-mask-stripesDiagonalUpOut`
- `ca__fx-mask-stripesHorizontalReverseIn`
- `ca__fx-mask-stripesHorizontalReverseOut`
- `ca__fx-mask-stripesIn`
- `ca__fx-mask-stripesJitterIn`
- `ca__fx-mask-stripesJitterOut`
- `ca__fx-mask-stripesThinIn`
- `ca__fx-mask-stripesThinOut`
- `ca__fx-mask-stripesVerticalIn`
- `ca__fx-mask-stripesVerticalOut`
- `ca__fx-mask-stripesWideIn`
- `ca__fx-mask-stripesWideOut`
- `ca__fx-mask-threadLinesIn`
- `ca__fx-mask-topFadeIn`
- `ca__fx-mask-verticalScanIn`
- `ca__fx-mask-wipeLeftIn`
- `ca__fx-mask-zigzagRevealIn`
- `ca__fx-matrixWave`
- `ca__fx-microGlitch`
