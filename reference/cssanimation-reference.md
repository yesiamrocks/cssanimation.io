...
- `ca__fx-gearSnapIn`
- `ca__fx-glintReveal`
- `ca__fx-glitchCollapseOut`
- `ca__fx-glitchCompressIn`
- `ca__fx-glitchDecodePulse`
- `ca__fx-glitchExit`
- `ca__fx-glitchFlash`
- `ca__fx-glitchJitter`
- `ca__fx-glitchMatrixWave`
- `ca__fx-glitchPopIn`
- `ca__fx-glitchScanBurst`
- `ca__fx-glitchSequence`
- `ca__fx-glitchSlice`
- `ca__fx-glitchSliceCrack`
- `ca__fx-glitchSliceDrop`
- `ca__fx-glitchSliceExitCollapse`
