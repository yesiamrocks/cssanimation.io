...
function initTweenMax() {
  ...
  TweenMax.staggerTo(
    ".snake span",
    0.75,
    { y: 30, yoyo: true, repeat: -1, ease: Sine.easeInOut },
    0.2
  );
  ...
  TweenMax.staggerTo(
    ".leSkateX span",
    0.5,
    { scaleX: 0.4, ease: Sine.easeInOut, yoyo: true, repeat: -1 },
    0.2
  );
  TweenMax.staggerTo(
    ".leSkateY span",
    0.5,
    { scaleY: 0.4, ease: Sine.easeInOut, yoyo: true, repeat: -1 },
    0.2
  );
  ...
  TweenMax.staggerFrom(
    ".leZoomInBottom span",
    1,
    { scale: 10, y: 700, autoAlpha: 0, perspective: 600, ease: Power2.easeOut },
    0.2
  );
...
TweenMax.to(".coolHorizontalShake", 0.1, { x: "+=20", yoyo: true, repeat: -1 });
TweenMax.to(".coolHorizontalShake", 0.1, { x: "-=20", yoyo: true, repeat: -1 });
