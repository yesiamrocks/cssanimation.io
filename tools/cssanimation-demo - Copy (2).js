    ...
    <div class="max-w-7xl mx-auto pt-6 pb-6 px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col lg:flex-row gap-8">
            ...
            <div class="w-full lg:w-1/4">
                <div id="categories" class="sticky top-6 overflow-y-auto max-h-[calc(100vh-150px)] flex flex-col gap-2 px-2">
            ...
            <!-- Main Gallery -->
            <div id="gallery" class="w-full lg:w-3/4 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
