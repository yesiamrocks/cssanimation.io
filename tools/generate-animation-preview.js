// tools/generate-animation-preview.js
...
// Paths - 3. Adjust all path.resolve calls to use the new __dirname
...
// HTML Template (no changes needed here, just part of the string literal)
...
// Write HTML to file - 4. Ensure output path is resolved correctly
fs.writeFileSync(outputHtmlPath, html);
console.log(`✅ Generated animation-preview.html with ${allClassNames.length} animations and categories from JSON.`);
