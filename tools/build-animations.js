...
const outputDir = path.resolve(__dirname, '../dist/animations'); // Output individual animation files here
const indexFile = path.join(outputDir, 'ca__animations-index.css'); // Index file to import all modules
