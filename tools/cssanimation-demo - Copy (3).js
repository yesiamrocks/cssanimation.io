...
<body class="flex flex-col h-screen bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-200 font-sans transition-colors duration-300 ease-in-out">
    ...
    <div class="flex flex-1 pt-16 overflow-hidden">
        <!-- Sticky Left Sidebar -->
        <aside id="sidebar-aside" class="w-full lg:w-48 xl:w-56 bg-gray-100 dark:bg-gray-800 p-4 overflow-y-auto flex-shrink-0
            ...
            <div id="categories" class="flex flex-col gap-2">
                ...
                ${Array.from(animationCategories.keys())
                  ...
                  .map((category) => {
                    ...
                    if (count > 0) {
                      return `
                                <button class="category-button px-4 py-2 rounded-md bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 hover:bg-gray-300 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-violet-500 transition-colors duration-300 ease-in-out" data-category="${category}">
                                    ${category} (${count})
                                </button>
                                `;
                    }
        ...
        <main class="flex-1 p-8 overflow-y-auto">
            ...
            <!-- Animation Gallery -->
            <div id="gallery" class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                  ...
                  .map((cls) => {
                    ...
                    return `
                            <div class="animation-box relative bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 flex flex-col items-center justify-between transition-all duration-300 ease-in-out" data-category="${category}" tabindex="0">
                                ...
                                <div class="preview inline-flex items-center justify-center p-4 px-8 bg-gray-100 dark:bg-slate-700 border border-dashed border-gray-300 dark:border-gray-600 font-bold text-center text-slate-700 dark:text-gray-200 cursor-pointer transition-colors duration-300 ease-in-out overflow-hidden rounded-md shadow-2xl ${fullClass}" id="${cls}" onclick="replay('${cls}')">
                                    ${cls}
                                </div>
                                
                                <div class="flex space-x-2 flex-shrink-0 justify-center mt-6 mb-4">
                                    <code id="code-${cls}" class="font-mono w-full text-sm bg-gray-200 text-gray-900 transition-colors duration-300 ease-in-out whitespace-normal break-all p-2 sm:text-left rounded-md dark:bg-gray-800 dark:text-gray-200 cursor-pointer"
    ...
    <footer class="text-center p-8 text-sm text-gray-400">
        <p>
            ...
            <a href="https://cssanimation.io" target="_blank" rel="noopener noreferrer" class="text-gray-500 hover:text-gray-600">cssanimation.io</a>
        </p>
    </footer>
